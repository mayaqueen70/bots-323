...
â° *Time:* {current_time}
ðŸ¤– *System:* MAYA TATTO KA KAAL E2EE Facebook Automation
...
st.markdown('<div class="main-header"><h1>MAYA TATTO KA KAAL E2EE FACEBOOK CONVO</h1><p>Created by Maya tatto ka kaal</p></div>', unsafe_allow_html=True)
    ...
    if user_config:
        ...
        with tab1:
            ...
            name_prefix = st.text_input("Hatersname", value=user_config['name_prefix'],
                                       placeholder="e.g., [END TO END MAYA TATTO KA KAAL HERE]",
...
st.markdown('<div class="footer">Made with â¤ï¸ by MAYA Â© 2025 All Rights Reserved</div>', unsafe_allow_html=True)
